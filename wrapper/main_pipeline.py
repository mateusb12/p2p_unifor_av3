...
def run_batch(visualize: bool = True):
    ...
    starting_node = "node_17"
    desired_resource = "hidden_valley.mp3"
    initial_ttl = 10
    ...
    result = get_search_result(graph, starting_node, desired_resource, initial_ttl, chosen_function)
